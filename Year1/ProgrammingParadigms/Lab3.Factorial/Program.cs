/*
 * Дано натуральное число п; найти п!. Использовать программу,
 * включающую как рекурсивную, так и не рекурсивную функцию
 * вычисления n!. Чем рекурсивная функция хуже не рекурсивной? 
 */
